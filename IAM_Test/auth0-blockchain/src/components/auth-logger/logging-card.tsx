    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="flex flex-col sm:flex-row gap-4">
          <Button onClick={logAccess} disabled={!isReady || isLogging} className="flex-1">
            {isLogging ? <Loader className="mr-2 h-4 w-4 animate-spin" /> : <Pencil className="mr-2" />}
            {isLogging ? 'Logging Event...' : 'Log Access Event'}
          </Button>
